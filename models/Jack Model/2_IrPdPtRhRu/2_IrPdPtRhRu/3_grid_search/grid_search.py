...
# Set composition
composition = [0.2000,0.200,0.2000,0.2000,0.2000]
...
def calculate_activity (metals, composition):
    ...
    path = r'C:\Users\ahmad.tirmidzi\OneDrive - Universitaet Bern\Documents\Others model\Jack Model\2_IrPdPtRhRu\2_machine_learning_model'
...
#calculate_activity(metals = metals, composition = composition)
