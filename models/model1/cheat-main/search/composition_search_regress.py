...
# Objective function
def comp2act(comp, regressor):#, filename=None):
    # Construct surface
...
def calculate_activity(elements, composition, regressor):
    # set random seed
    np.random.seed(14)
    
    # Calculate activity
    activity = comp2act(dict(zip(elements, composition)), regressor)
