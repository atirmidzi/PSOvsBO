...
def load_GCN(kwargs_dict, trained_state=None):
	class GCNN(torch.nn.Module):
		def __init__(self,
			...
			self.out_dim = 1
			self.act = act
			self.att = AttentionalAggregation(Linear(conv_dim, 1))
    ...
    #torch.save(model.state_dict(), r"C:\Users\ahmad.tirmidzi\OneDrive - Universitaet Bern\Documents\Others model\Christian Model\cheat-main\regression\model_states\temp.model")
	return model
